...
#ifndef __unitree_states_LegControlCommand_hpp__
#define __unitree_states_LegControlCommand_hpp__
...
int LegControlCommand::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int LegControlCommand::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int LegControlCommand::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t LegControlCommand::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* LegControlCommand::getTypeName()
{
    return "LegControlCommand";
}

int LegControlCommand::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int LegControlCommand::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int LegControlCommand::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t LegControlCommand::_computeHash(const __lcm_hash_ptr *)
{
