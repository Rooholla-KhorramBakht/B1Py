...
# with input from unitree_msgs:msg/LowCmd.idl
...
class Metaclass_LowCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from B1Py.msgs.ros2.unitree import MotorCmd
...
class LowCmd(metaclass=Metaclass_LowCmd):
    ...
    _fields_and_field_types = {
        ...
        'version': 'uint32[2]',
        'band_width': 'uint16',
        'motor_cmd': 'unitree_msgs/MotorCmd[20]',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['unitree_msgs', 'msg'], 'MotorCmd'), 20),  # noqa: E501
