...
def generate_launch_description():
    ...
    launch1 = IncludeLaunchDescription(PythonLaunchDescriptionSource([launch1_path]))
    launch2 = IncludeLaunchDescription(PythonLaunchDescriptionSource([launch2_path]))

    # Launch description
    return LaunchDescription([launch1, TimerAction(period=5, actions=[launch2])])
