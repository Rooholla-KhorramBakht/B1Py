...
#include "unitree_msgs/msg/low_cmd.h"
#include "unitree_msgs/msg/low_state.h"
#include "unitree_msgs/msg/high_cmd.h"
#include "unitree_msgs/msg/high_state.h"
#include "unitree_msgs/msg/motor_cmd.h"
#include "unitree_msgs/msg/motor_state.h"
#include "unitree_msgs/msg/bms_cmd.h"
#include "unitree_msgs/msg/bms_state.h"
#include "unitree_msgs/msg/imu.h"
#include "unitree_legged_sdk/unitree_legged_sdk.h"
#include "rclcpp/rclcpp.hpp"

UNITREE_LEGGED_SDK::BmsCmd rosMsg2Cmd(const unitree_msgs::msg::BmsCmd &msg)
{
...
UNITREE_LEGGED_SDK::HighCmd rosMsg2Cmd(const unitree_msgs::msg::HighCmd::SharedPtr &msg)
{
...
UNITREE_LEGGED_SDK::MotorCmd rosMsg2Cmd(const unitree_msgs::msg::MotorCmd &msg)
{
...
UNITREE_LEGGED_SDK::LowCmd rosMsg2Cmd(const unitree_msgs::msg::LowCmd::SharedPtr &msg)
{
...
unitree_msgs::msg::MotorState state2rosMsg(UNITREE_LEGGED_SDK::MotorState &state)
{
...
unitree_msgs::msg::IMU state2rosMsg(UNITREE_LEGGED_SDK::IMU &state)
{
...
unitree_msgs::msg::BmsState state2rosMsg(UNITREE_LEGGED_SDK::BmsState &state)
{
...
unitree_msgs::msg::LowState state2rosMsg(UNITREE_LEGGED_SDK::LowState &state)
{
...
unitree_msgs::msg::Cartesian state2rosMsg(UNITREE_LEGGED_SDK::Cartesian &state)
{
...
unitree_msgs::msg::HighState state2rosMsg(UNITREE_LEGGED_SDK::HighState &state)
{
