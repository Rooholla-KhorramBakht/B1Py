...
configurable_parameters = [{'name': 'camera_name',                  'default': 'b1_d455_cam', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.profile',         'default': '640,480,60', 'description': 'depth module profile'},                           
                           ...
                           {'name': 'depth_module.exposure.1',     'default': '2000', 'description': 'Initial value for hdr_merge filter'},
                           ...
                           {"name": "depth_module.emitter_enabled", "default": "0","description": "Do we need the laser projector?",},
                          ]
    ...
    if (os.getenv('ROS_DISTRO') == "dashing") or (os.getenv('ROS_DISTRO') == "eloquent"):
        return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
            ...
            launch_ros.actions.Node(
                ...
                node_namespace='b1', #LaunchConfiguration("camera_name"),
