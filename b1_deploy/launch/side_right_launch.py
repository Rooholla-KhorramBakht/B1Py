...
configurable_parameters = [{'name': 'camera_name',                  'default': 'right', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'side_cam', 'description': 'namespace for camera'},
