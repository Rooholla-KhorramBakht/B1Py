...
configurable_parameters = [{'name': 'camera_name',                  'default': 'forward', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'front_cam', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'141122079634'" , 'description': 'choose device by serial number'},
